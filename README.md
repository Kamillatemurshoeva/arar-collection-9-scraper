...
**Collection:** ARAR Collection 9  
**Collection URL:** https://arar.sci.am/dlibra/results?q=&action=SimpleSearchAction&type=-6&p=0&qf1=collections:9
...
main.py  
arar_collection_9.csv  
arar_collection_9.jsonl  
README.md  
LICENSE  
DATA_RIGHTS.md  
requirements.txt  
...
It is **not officially affiliated with the Pan-Armenian Digital Library (ARAR)** or any holding institution unless explicitly stated.
